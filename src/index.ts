...
const defaultErr = new Map<string, string>();
const parentFlags = [true, true];

const allInput: { [key: string]: { type: "input" | "select", isRequired: boolean, onValidation: (element: HTMLInputElement | HTMLSelectElement | HTMLSelectElement) => Promise<boolean> | boolean, onKeyChange: (element: HTMLInputElement | HTMLSelectElement | HTMLSelectElement) => Promise<boolean> | boolean, onClick: (element?: HTMLElement) => void } } = {
    sCfname: {
        type: "select",
        isRequired: true,
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLSelectElement) {
                if (element.selectedIndex == 0) return false
            }
            return true;
        },
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLSelectElement) {
            }
            return true;
        },
    ...
    sFname: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                ...
                if (!/^[ก-๙]+$/.test(element.value)) return false
            }
            return true;
        },
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
    ...
    sPIN: {
        ...
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (!idCardCheck(element.value.replaceAll("-", ""))) return false
            }
            return true;
        },
        onClick: () => {
    ...
    sTel: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (element.value.replaceAll("-", "").length !== 10) return false
            }
            return true;
        },
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
    ...
    sHno: {
        ...
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (($("#sameAddress").get(0) as HTMLInputElement).checked) {
    ...
    sHzipcode: {
        ...
        onKeyChange: async (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (element.value.length == 5) {
                    ...
                    const data = await fetch(`https://apply.pcshs.ac.th/Admission/register/searchtumbons?sHzipcode=${sHzipcode}`, {
                        method: "GET",
                    })

                    var results = await data.json() as { sHprovince: string, sHzipcode: string, sHtambon: string, sHamphoe: string, ID: string }[] ?? [];
    ...
    sameAddress: {
        ...
        onClick: (ev) => {
            ...
            if (ev instanceof HTMLInputElement) {
                if ((sameAddressElement.get(0) as any).checked) {
                    ...
                    ["sHnoNow", "sHmooNow", "sHroadNow", "sHzipcodeNow", "sHdistrictNow", "sHsoiNow", "sHamphoeNow", "sHprovinceNow"].forEach(id => {
                        ($(`#${id}`).get(0) as HTMLInputElement).readOnly = true
                    })
                    addressLinkS(["sHnoNow", "sHmooNow", "sHroadNow", "sHzipcodeNow", "sHdistrictNow", "sHsoiNow", "sHamphoeNow", "sHprovinceNow"], ["sHno", "sHmoo", "sHroad", "sHzipcode", "sHdistrict", "sHsoi", "sHamphoe", "sHprovince"]);
                } else {
                    ...
                    ["sHnoNow", "sHmooNow", "sHroadNow", "sHsoiNow", "sHzipcodeNow"].forEach(id => {
                        $(`#${id}`).val("");
                        ($(`#${id}`).get(0) as HTMLInputElement).readOnly = false
                    })
    ...
    fLiving: {
        ...
        onClick: () => {
            ...
            for (let i = 0; i < allL.length; i++) {
                (allL.item(i) as HTMLInputElement).readOnly = false
                $(allL.item(i)).val("")
            }
    ...
    fLivingNotKnow: {
        ...
        onClick: () => {
            ...
            const allL = document.getElementsByClassName("fatherDeceased")
            for (let i = 0; i < allL.length; i++) {
                (allL.item(i) as HTMLInputElement).readOnly = true
                $(allL.item(i)).val("")
            }
            for (let i = 0; i < allD.length; i++) {
                const allEle = allD.item(i).getElementsByTagName("input")
            ...
            (document.getElementById("fCfname") as HTMLSelectElement).disabled = false;
            (document.getElementById("fFname") as HTMLInputElement).readOnly = false;
            (document.getElementById("fLname") as HTMLInputElement).readOnly = false;
        }
    },
    fDeceased: {
        type: "input",
    ...
    fCfname: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLSelectElement) {
                if (($("#fLiving").get(0) as HTMLInputElement).checked || ($("#fDeceased").get(0) as HTMLInputElement).checked || ($("fLivingNotKnow").get(0) as HTMLInputElement).checked) {
                    if (element.selectedIndex == 0) return false
                }
            }
            return true;
    ...
    fPIN: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (($("#fLiving").get(0) as HTMLInputElement).checked) {
                    if (!idCardCheck(element.value.replaceAll("-", ""))) return false
                }
            }
            return true;
    ...
    fWorkplaceTel: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (($("#fLiving").get(0) as HTMLInputElement).checked) {
                    if (element.value.replaceAll("-", "").length !== 9) return false
                }
            }
            return true;
        },
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (($("#fLiving").get(0) as HTMLInputElement).checked) {
                    if (element.value.length !== 9) return false
                }
            }
            return true;
        },
    ...
    fTel: {
        ...
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (($("#fLiving").get(0) as HTMLInputElement).checked) {
                    if (element.value.length !== 10) return false
                }
            }
            return true;
        },
    ...
    fsameAddress: {
        ...
        onClick: () => {
            if (($("#fLiving").get(0) as HTMLInputElement).checked) {
                if ((document.getElementById("sameAddress") as HTMLInputElement).readOnly == false) {
                    if (($("#fsameAddress").get(0) as HTMLInputElement).checked) {
    ...
    mLivingNotKnow: {
        ...
        onClick: () => {
            ...
            (document.getElementById("mCfname") as HTMLSelectElement).disabled = false;
            (document.getElementById("mFname") as HTMLInputElement).readOnly = false;
            (document.getElementById("mLname") as HTMLInputElement).readOnly = false;
        }
    },
    mDeceased: {
        type: "input",
    ...
    mCfname: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (($("#mLiving").get(0) as HTMLInputElement).checked || ($("#mDeceased").get(0) as HTMLInputElement).checked || ($("#mLivingNotKnow").get(0) as HTMLInputElement).checked) {
                    if (element.value.length <= 0) return false
                }
            }
            return true;
    ...
    mPIN: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (($("#mLiving").get(0) as HTMLInputElement).checked) {
                    if (!idCardCheck(element.value.replaceAll("-", ""))) return false;
                }
            }
            return true;
    ...
    msameAddress: {
        ...
        onClick: () => {
            if (($("#mLiving").get(0) as HTMLInputElement).checked) {
                if ((document.getElementById("sameAddress") as HTMLInputElement).readOnly == false) {
                    if (($("#msameAddress").get(0) as HTMLInputElement).checked) {
    ...
    sParentf: {
        ...
        onClick: () => {
            ...
            ["fCfname", "fFname", "fLname", "fPIN", "fRace", "fNation", "fReligion", "fBirthday", "fBirthmonth", "fBirthyear", "fOccu", "fEarnings", "fWorkplace", "fWorkplaceTel", "fTel", "fMail", "fsameAddress", "fHno", "fHmoo", "fHroad", "fHsoi", "fHdistrict", "fHamphoe", "fHprovince", "fHzipcode"].forEach(id => {
                if (allInput[id].onValidation((document.getElementById(id) as HTMLInputElement) ?? (document.getElementById(id) as HTMLSelectElement)) == false) {
                    console.log(id)
                    isPass = false
                }
            });
            //clear
            ($("#pFname").get(0) as HTMLSelectElement).selectedIndex = 0
            $("#pFname").val("")
            $("#pLname").val("")
            $("#pPIN").val("")
            $("#pRace").val("")
            $("#pNation").val("");
            ($("#pReligion").get(0) as HTMLSelectElement).selectedIndex = 0;
            ($("#pBirthday").get(0) as HTMLSelectElement).selectedIndex = 0;
            ($("#pBirthmonth").get(0) as HTMLSelectElement).selectedIndex = 0;
            ($("#pBirthyear").get(0) as HTMLSelectElement).selectedIndex = 0;
            ($("#pOccu").get(0) as HTMLSelectElement).selectedIndex = 0;
            $("#pEarnings").val("")
            $("#pWorkplace").val("")
            $("#pWorkplaceTel").val("")
            $("#pTel").val("")
    ...
    sParento: {
        ...
        onClick: () => {
            ($("#pCfname").get(0) as HTMLSelectElement).selectedIndex = 0
            $("#pFname").val("")
            $("#pLname").val("")
            $("#pPIN").val("")
            $("#pRace").val("")
    ...
    sGPAm: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (element.value.replaceAll(".", "").length !== 3) return false
            }
            return true;
        },
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
    ...
    sContractf: {
        ...
        onClick: () => {
            ...
            //clear
            ($("#conFname").get(0) as HTMLSelectElement).selectedIndex = 0
            $("#conFname").val("")
            $("#conLname").val("")
            $("#conPIN").val("");
            ($("#conOccu").get(0) as HTMLSelectElement).selectedIndex = 0;
            $("#conEarnings").val("")
            $("#conWorkplace").val("")
            $("#conWorkplaceTel").val("")
            $("#conTel").val("")
    ...
    conPIN: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (element.value.replaceAll("-", "").length !== 13) return false
            }
            return true;
        },
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
    ...
    conWorkplaceTel: {
        ...
        onValidation: (element: HTMLInputElement | HTMLSelectElement) => {
            if (element instanceof HTMLInputElement) {
                if (element.value.replaceAll("-", "").length <= 0) return false
            }
            return true;
        },
        onKeyChange: (element: HTMLInputElement | HTMLSelectElement) => {
...
Object.keys(allInput).forEach(async (id) => {
    const checkData = document.getElementById(id)
    checkData.addEventListener("keyup", async (ev) => {
        const checked = await allInput[id].onKeyChange(checkData as HTMLInputElement)
        if (!checked) {
    ...
    checkData.addEventListener("change", async (ev) => {
        const checked = await allInput[id].onKeyChange(checkData as HTMLSelectElement)
        if (!checked) {
            const element = document.getElementById(id)
            if (element instanceof HTMLSelectElement) {
    ...
    checkData.addEventListener("click", (ev) => {
        allInput[id].onClick(ev.currentTarget as HTMLInputElement)
    })
})

const validation: Map<string, boolean> = new Map<string, boolean>()
...
doc.disabled = true
doc.selected = true
const doc2 = doc.cloneNode(true) as HTMLOptionElement
const doc3 = doc.cloneNode(true) as HTMLOptionElement
const doc4 = doc.cloneNode(true) as HTMLOptionElement
doc2.selected = true
doc3.selected = true
doc4.selected = true
...
Object.keys(allInput).forEach(async (id, i) => {
    const checkData = allInput[id]
    if (checkData.isRequired) {
        const data = await checkData.onValidation(document.getElementById(id) as HTMLInputElement | HTMLSelectElement)
...
document.getElementById("submit-form").addEventListener("click", (ev) => {
    if (!Array.from(validation).map(x => x[1]).some(x => x == false)) {
        ...
        for (let i = 0; i < allElement.length; i++) {
            try {
                if ((allElement.item(i) as HTMLInputElement).disabled && (allElement.item(i) as HTMLInputElement).disabled == true) {
                    (allElement.item(i) as HTMLInputElement).disabled = false
                }
            } catch(e) {}
        }
        const formData = new FormData(document.getElementById("info-form") as HTMLFormElement)
...
function addressSelect(ID: string, sHzipcode: string, sHtambon: string, sHamphoe: string, sHprovince: string, prefix: string, linked?: string) {
    var resultsContainer = $(`#Sresults${prefix}`);
    if (document.getElementById(`sameAddress${prefix}`) !== null) {
        ($(`#sameAddress${prefix}`).get(0) as any).disabled = false;
        ($(`#fsameAddress`).get(0) as any).disabled = false;
        ($(`#msameAddress`).get(0) as any).disabled = false;
        ($(`#sPsamef`).get(0) as any).disabled = false;
    ...
    if (linked) {
        if (($(`#sameAddress${prefix}`).get(0) as HTMLInputElement).checked) {
...
function addressLinkS(item: string[], item2: string[]) {
    item2.forEach((it, i) => {
        $(`#` + item[i]).val($(`#` + it).val());
    })
}

function idCardCheck(id_card: string) {
    if (!Number(id_card)) return false
    if (id_card.substring(0, 1) as any === 0) return false
